#!/usr/bin/env python3
"""
Script to generate a comprehensive MMPI-2 report with embedded graphs and harmonized DSM-5-TR narrative integration.
This enhanced version addresses formatting issues, embeds graphs at appropriate locations within the report narrative,
and ensures seamless integration between detailed scale interpretations and DSM-5-TR diagnostic impressions.
"""
...
from src.interpretation.narrative_dsm5tr_integration import harmonize_narrative_with_dsm5tr

# Output directory
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "harmonized_report_output")
...
def generate_html_report(profile_data, graph_paths, harmonized_narrative):
    """Generate an HTML report with embedded graphs and harmonized narrative."""
    ...
    summaries = {
        ...
        "rc": "The RC scales show significant elevations on RCd (Demoralization, T=75), RC2 (Low Positive Emotions, T=75), and RC7 (Dysfunctional Negative Emotions, T=80). These findings align with the clinical scales and indicate marked distress.",
